        ...
        <div className="app header-fixed footer-fixed" >
          <div>
            ...
            <div className="app-body " >
              ...
              <main className="main" >
              <Switch>
                <Route  path="/AdminDashboard/studentShow/:id" name="Student Show" component={StudentShow} />
                <Route  path="/AdminDashboard/facultyShow/:id" name="Faculty Show" component={FacultyShow} />
