...
import FacultyProfile from './ssrsview/Faculty/Profile';
    ...
    return (
      <Router>
          <Switch>
            ...
            <Route  path="/AdminDashboard/student" name="Admin Dashboard" component={AdminDashboard}/> 
            <Route  path="/AdminDashboard/synopsis" name="Admin Dashboard" component={AdminDashboard}/> 
            <Route  path="/AdminDashboard/faculty" name="Admin Dashboard" component={AdminDashboard}/>
